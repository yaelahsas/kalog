    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('dashboard/facilities/edit/'.$facility->id, ['class' => 'form-horizontal']); ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="tipe" name="tipe" value="<?php echo set_value('tipe', $facility->tipe); ?>" placeholder="Masukkan Tipe" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="kapasitas" name="kapasitas" value="<?php echo set_value('kapasitas', $facility->kapasitas); ?>" placeholder="Masukkan Kapasitas">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?php echo set_value('jumlah', $facility->jumlah); ?>" placeholder="Masukkan Jumlah" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="tahun_unit" name="tahun_unit" value="<?php echo set_value('tahun_unit', $facility->tahun_unit); ?>" placeholder="Masukkan Tahun Unit">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="awal_sewa" name="awal_sewa" value="<?php echo set_value('awal_sewa', $facility->awal_sewa); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="akhir_sewa" name="akhir_sewa" value="<?php echo set_value('akhir_sewa', $facility->akhir_sewa); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="total_harga_sewa" name="total_harga_sewa" value="<?php echo set_value('total_harga_sewa', $facility->total_harga_sewa); ?>" placeholder="Masukkan Total Harga Sewa">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="no_perjanjian" name="no_perjanjian" value="<?php echo set_value('no_perjanjian', $facility->no_perjanjian); ?>" placeholder="Masukkan No. Perjanjian">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="keterangan" name="keterangan" rows="3" placeholder="Masukkan Keterangan"><?php echo set_value('keterangan', $facility->keterangan); ?></textarea>
