        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return `
                        <div class="btn-group">
                            <a href="<?php echo site_url('dashboard/facility_types/edit/'); ?>` + row.id + `" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteFacilityType(` + row.id + `)">
