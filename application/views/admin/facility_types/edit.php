    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('dashboard/facility_types/edit/'.$id, ['class' => 'form-horizontal']); ?>
              
              <div class="form-group row">
                <label for="nama_tipe" class="col-sm-2 col-form-label">Nama Jenis Fasilitas</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama_tipe" name="nama_tipe" value="<?php echo set_value('nama_tipe', $data->nama_tipe); ?>" placeholder="Masukkan Nama Jenis Fasilitas" required>
