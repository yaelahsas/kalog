    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('dashboard/vendors/add', ['class' => 'form-horizontal']); ?>
              
              <div class="form-group row">
                <label for="nama_vendor" class="col-sm-2 col-form-label">Nama Vendor</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama_vendor" name="nama_vendor" value="<?php echo set_value('nama_vendor'); ?>" placeholder="Masukkan Nama Vendor" required>
